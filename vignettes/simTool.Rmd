...
In the same fashtion one could write a data analyzing function with a parameter *.truth*.
...
more precise lets look at an excerpt of the psudeo code from the beginning 
of the vignette:
