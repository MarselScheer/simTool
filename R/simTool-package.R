...
#' analyzes the data. The main aims of the \code{simTool} package are the
#' reduction
...
#' quickly learn how to work with the \code{simTool} package. Parallel
#' computing is
...
#'  \code{evalGrids} is the workhorse. \code{as.data.frame} is function
#'  coercing the result object of evalGrids to
